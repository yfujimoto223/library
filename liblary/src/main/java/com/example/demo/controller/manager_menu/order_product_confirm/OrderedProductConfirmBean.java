...
public class OrderedProductConfirmBean extends AbstractBean {
	/**注文日From**/
	...
	/**納品された書籍検索結果**/
	private List<SearchOrderBookCompleted> searchResultList = new ArrayList<SearchOrderBookCompleted>();
	...
	public void factorySearchResultList(注文書籍ValueObject valueObject) {
		for (注文Dto 注文 : valueObject.注文情報を取得する()) {
			...
			SearchOrderBookCompleted searchResult = new SearchOrderBookCompleted();
			...
			searchResult.setCompletedFlg(valueObject.is納品済みフラグ());
			searchResultList.add(searchResult);

		}
	}

	public class SearchOrderBookCompleted {
	...
	public List<SearchOrderBookCompleted> getSearchResultList() {
		return searchResultList;
	}

	public void setSearchResultList(List<SearchOrderBookCompleted> searchResultList) {
